...
Эти endpoint'ы сознательно исключены из текущей рабочей OpenAPI-документации: они не нужны для ближайших MCP/сервисов, слишком рискованные для тестов или не несут полезной нагрузки сейчас. Полная OpenAPI-заготовка сохранена в `musicalligator-excluded.openapi.yaml`, чтобы вернуть их без повторного reverse engineering.
